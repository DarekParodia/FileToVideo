...
namespace settings
{
    ...
    namespace video
    {
        ...
        unsigned int fps = 30;
        unsigned int pixel_size = 4;  // just artificial width and height of pixel for reliability with compression // for now make sure thath width and height are divisible by pixel size
